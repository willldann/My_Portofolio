...
const timelineEvents = [
  {
    year: 2022,
    title: "Imam Syafii Islamic Integrated Junior High School.",
    description: "An integrated Islamic school committed to shaping a generation with strong morals, academic excellence, and a broad understanding of science and technology.",
    details:
      "With an Islamic-based education approach, SMPIT Imam Syafii Batam instills strong Islamic values while equipping students with modern academic and technological skills. Through interactive learning, extracurricular activities, and a Tahfidz program, we nurture a generation prepared to face future challenges with faith and knowledge.",
  },
  {
    year: 2023,
    title: "IDN Boarding Vocational High School Solo.",
    description: "A leading technology-focused boarding school dedicated to shaping the next generation of IT professionals.",
    details:
      "With a strong emphasis on practical learning, our students excel in software development, cybersecurity, and network engineering.Through hands-on projects, competitions, and industry partnerships, we prepare them for real-world challenges in the ever-evolving tech landscape",
  },
  // {
  //   year: 2020,
